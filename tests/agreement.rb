...
accept 'Max goes.' do
  as "cp(c_(ip(dp(d_(np(n_(n(max))))),i_(i(pres),vp(v_(v(goes)))))))
  [pres(e/1),go(e/1,max)]"
end

accept 'Max went.' do
  as "cp(c_(ip(dp(d_(np(n_(n(max))))),i_(i(pret),vp(v_(v(went)))))))
  [pret(e/1),go(e/1,max)]"
end
...
accept 'The boy went.' do
  as "cp(c_(ip(dp(d_(d(the),np(n_(n(boy))))),i_(i(pret),vp(v_(v(went)))))))
  [pret(e/1),go(e/1,x/1),boy(x/1)]"
end

accept 'The boys go.' do
  as "cp(c_(ip(dp(d_(d(the),np(n_(n(boys))))),i_(i(pres),vp(v_(v(go)))))))
  [pres(e/1),go(e/1,x/1),boys(x/1)]"
end

accept 'The boys went.' do
  as "cp(c_(ip(dp(d_(d(the),np(n_(n(boys))))),i_(i(pret),vp(v_(v(went)))))))
...
accept 'The boys meet the girl.' do
  as "cp(c_(ip(dp(d_(d(the),np(n_(n(boys))))),i_(i(pres),vp(v_(v(meet),dp(d_(d(the),np(n_(n(girl)))))))))))
